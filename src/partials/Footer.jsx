            ...
            <section className="footer__end">
                ...
                <div>
                    ...
                    <div className="copyright">
                        <p>© 2024 | {copy.copyright_1_1} | <a id='terms' href="https://secure.giveandget.io/terms">{copy.copyright_1_2}</a> | <a id="privacy" href="https://secure.giveandget.io/privacy">{copy.copyright_1_3}</a></p>
                    </div>
                </div>
            </section>
        </footer>
